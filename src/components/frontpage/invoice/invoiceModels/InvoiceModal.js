...
class InvoiceModal extends React.Component {
  ...
  sendInvoiceToFirestore = async () => {
    const invoiceData = {
      ...
      taxableAmount: this.props.valueWithoutGst,
      nonTaxableAmount: this.props.NonTaxableAmount,
      discount: this.props.discount,
      CGST: this.props.CGSTAmount,
      SGST: this.props.SGSTAmount,
      IGST: this.props.IGSTAmount,
      total: this.props.subTotal - this.props.discount,
    };
