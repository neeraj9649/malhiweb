...
class InvoiceModal extends React.Component {
  ...
  sendInvoiceToFirestore = async () => {
    this.setState({ loading: true }); // Set loading to true when starting to send
    const invoiceData = {
    ...
    try {
      ...
      console.log(
        "Invoice successfully saved to Firestore with ID:",
        docRef.id
      );
    } catch (e) {
      console.error("Error saving invoice to Firestore:", e);
    } finally {
      this.setState({ loading: false }); // Reset loading state after sending
    }
  };

  // Function to generate invoice PDF
  GenerateInvoice = () => {
    const pdfName = this.props.info.billTo
      ? `${this.props.info.billTo}.pdf`
      : "default-invoice-name.pdf";
            ...
            <div className="d-flex flex-row justify-content-between align-items-start bg-light w-100 p-2">
              ...
              <div className="text-center me-3">
                ...
                <div className="me-5">
                  ...
                  >
                    <strong>
                      JALANDHAR CANTT HEAD POST OFFICE, JASVIR SINGH S/O AJIT
                      SINGH, OLD PHAGWARA ROAD, DEEP NAGAR, JALANDHAR
                      <br />
            ...
            <div className="p-4">
              <Row className="mb-4">
                <Col md={4} className="me-5">
                  ...
                  <div>
                    <p>
                      <strong>
                        Bill To: {this.props.info.billTo || ""}
                        <br />
                        Address: {this.props.info.billToAddress || ""}
                        <br />
                ...
                <Col md={4} className="ms-5">
                  ...
                  <div>
                    <p>
                      <strong>
                        Invoice NO: {this.props.info.billinvoiceno || ""}
                        <br />
                        Date: {this.props.info.dateOfIssue || ""}
                        <br />
                ...
                <div style={{ flex: 1 }}>
                  <p>
                    <strong>
                      ...
                      <b>Ac no :-</b> 5148114343
                      <br />
                      <b>IFSC code :-</b>KKBK0004020
                    </strong>
                  </p>
                </div>
                <div style={{ flex: 1 }}>
                      ...
                      {this.props.valueWithoutGs !== 0.0 && (
                        <tr className="text-end">
                          ...
                          <td className="text-end" style={{ width: "100px" }}>
                            {this.props.currency} {this.props.valueWithoutGst}
                          </td>
                        </tr>
                      )}
                      {this.props.NonTaxable !== 0.0 && (
                        <tr className="text-end">
                          <td></td>
                          <td className="fw-bold" style={{ width: "90px" }}>
                            NonTaxable{" "}
                          ...
                          <td className="text-end" style={{ width: "100px" }}>
                            {this.props.currency} {this.props.NonTaxableAmount}
                          </td>
                        </tr>
                      )}
                      {this.props.discountt !== 0.0 && (
                        <tr className="text-end">
                          <td></td>
                          <td className="fw-bold" style={{ width: "90px" }}>
                            Discount -
                          ...
                          <td className="text-end" style={{ width: "100px" }}>
                            {this.props.currency} {this.props.discount}
                          </td>
                        </tr>
                      )}
                      {this.props.CGST !== 0.0 && (
                        <tr className="text-end">
                          <td></td>
                          <td className="fw-bold" style={{ width: "90px" }}>
                            CGST {this.props.info.CGST}%
                          </td>
                          <td className="text-end" style={{ width: "100px" }}>
                            {this.props.currency} {this.props.CGSTAmount}
                          </td>
                        </tr>
                      )}
                      {this.props.SGST !== 0.0 && (
                        <tr className="text-end">
                          <td></td>
                          <td className="fw-bold" style={{ width: "90px" }}>
                            SGST {this.props.info.SGST}%
                          </td>
                          <td className="text-end" style={{ width: "100px" }}>
                            {this.props.currency} {this.props.SGSTAmount}
                          </td>
                        </tr>
                      )}
                      {this.props.IGST !== 0.0 && (
                        <tr className="text-end">
                          <td></td>
                          <td className="fw-bold" style={{ width: "90px" }}>
                            IGST {this.props.info.IGST}%
                          </td>
                          <td className="text-end" style={{ width: "100px" }}>
                            {this.props.currency} {this.props.IGSTAmount}
                          </td>
                        </tr>
                      )}
                      <tr className="text-end">
                        ...
                        <td className="text-end" style={{ width: "100px" }}>
                          {this.props.currency}{" "}
                          {this.props.subTotal - this.props.discount}
                        </td>
                      </tr>
                    </tbody>
                  </Table>
              ...
              <td>
                <strong>
                  ...
                  1. Payment of this invoice should be by crossed account payee
                  cheque / demand draft in favour of Malhi Enterprises.
                  <br />
                  2. Kindly notify us in writing regarding any discrepancy in
                  this invoice within seven days. Otherwise, this invoice shall
                  be deemed to be correct and payable by you.
                  <br />
                  3. Interest @2% per month will be charged on delayed payments.
                  <br />
                  4. Any discrepancy in this invoice must communicate in writing
                  within 7 days of date of invoice.
                  <br />
                  5. This is a computer-generated invoice with Digital
                  Signature. Does not require signature.
                  <br />
                  <br />
                  <br />
                  <br />
          ...
          <div className="pb-4 px-4">
            <Row className="d-flex justify-content-between align-items-center">
              ...
              {/* <Button
                variant="success"
                className="d-block"
                onClick={this.sendInvoiceToFirestore}
              >
                <BiPaperPlane
                  style={{ width: "16px", height: "16px", marginTop: "-3px" }}
                  className="me-2"
              ...
              >
                ...
                {this.state.loading ? " Sending..." : " Send Invoice"}
              </Button>
            </Row>
          </div>
        </Modal>
